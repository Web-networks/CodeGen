...
class Optimizer(neurogen.GeneratedClassBase):
    def __init__(self, obj):
        self = obj


class Loss(neurogen.GeneratedClassBase):
    def __init__(self, obj):
        self = obj


class Metrics(neurogen.GeneratedClassBase):
    def __init__(self, obj):
        self = obj
...
class Model(neurogen.GeneratedClassBase):
    def __init__(self, obj):
        ...
        self.optimizer = Optimizer(obj["optimizer"])
        self.loss = Loss(obj["loss"])
        self.metrics = Metrics(obj["metrics"])
