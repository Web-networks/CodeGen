...
class Window(QMainWindow):
    def __init__(self):
        ...
        prediction_button = QPushButton('GO', self)
    ...
    def print_number(self,result):
        numbers = "0123456789"
        self.line.setText(numbers[result])
